...
public class Lista {
    ...
    void showAllElements() {
        System.out.println(CYAN + this.readArray(this.tabla));
    }
    
    void resetTableFromRAM() {
        this.tabla = null;
        this.tabla = new Integer[0];
    }
    
    void decreaseLengthArrayIn1() {
        Integer resolve[] = new Integer[this.tabla.length - 1];
        System.arraycopy(this.tabla, 0, resolve, 0, resolve.length);
        this.tabla = null;
        this.tabla = new Integer[resolve.length];
        System.arraycopy(resolve, 0, this.tabla, 0, this.tabla.length);
        resolve = null;
    }
    
    private String readArray(Integer[] array) {
        String result;
