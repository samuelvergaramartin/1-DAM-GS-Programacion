...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (opcion) {
                ...
                case 4: {
                    contenedor.ordenar(new ComparaNombres());
                    System.out.println(contenedor);

                    break;
                }
                case 5: {
                    contenedor.ordenar(new ComparaAntiguedad());
                    System.out.println(contenedor);
    ...
    private static int menu() {
        ...
        final String MENU = """
                ...
                4- Listar socios ordenados por nombre
                5- Listar socios ordenados por antigüedad
                6- Salir
                """;
